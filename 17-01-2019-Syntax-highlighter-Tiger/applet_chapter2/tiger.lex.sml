...
let fun continue() = lex() in
 ...
 in (yybufpos := i; case yyk of 
  ...
  1 => ((*#line 14.8 "tiger.lex"*)lineNum := !lineNum+1; linePos := yypos :: !linePos; continue()(*#line 155.1 "tiger.lex.sml"*)
)
| 11 => ((*#line 17.11 "tiger.lex"*)Tokens.INT(123,yypos,yypos+3)(*#line 157.1 "tiger.lex.sml"*)
)
| 13 => let val yytext=yymktext() in (*#line 18.13 "tiger.lex"*)ErrorMsg.error yypos ("illegal character " ^ yytext); continue()(*#line 159.1 "tiger.lex.sml"*)
 end
| 3 => ((*#line 15.9 "tiger.lex"*)Tokens.COMMA(yypos,yypos+1)(*#line 161.1 "tiger.lex.sml"*)
)
| 7 => ((*#line 16.11 "tiger.lex"*)Tokens.VAR(yypos,yypos+3)(*#line 163.1 "tiger.lex.sml"*)
)
